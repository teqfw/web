/**
 * Connector to IndexedDb and wrapper for IDBObjectStore for TeqFW apps.
 */
const NS = 'TeqFw_Web_Front_Store_Connect';

/**
 * Connector to IndexedDb to use with async/await in TeqFW apps.
 * @deprecated use TeqFw_Web_Front_App_Store_IDB
 */
