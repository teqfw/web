...
export default class TeqFw_Web_Front_Event_Connect_Event_Direct_Closed {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{[data]: TeqFw_Web_Front_Event_Connect_Event_Direct_Closed.Dto, [meta]: TeqFw_Core_Shared_App_Event_Message_Meta.Dto}} [data]
         * @return {{data: TeqFw_Web_Front_Event_Connect_Event_Direct_Closed.Dto, meta: TeqFw_Core_Shared_App_Event_Message_Meta.Dto}}
         */
